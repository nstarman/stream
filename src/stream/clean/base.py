...
# LOCAL
from stream.utils.exceptions import NotFittedError
...
if TYPE_CHECKING:
    ...
    # LOCAL
    from stream._typing import N1, N2, NDFloat
...
# TODO! align the internals more closely with sklearn
class OutlierDetectorBase(metaclass=ABCMeta):
    ...
    `~stream.clean.base.OUTLIER_DETECTOR_CLASSES`. If registered,
    ...
    def __init_subclass__(cls, register: bool = True) -> None:
        ...
        register : bool, optional
            ...
            `~stream.clean.base.OUTLIER_DETECTOR_CLASSES`, by default `True`. If
            registered, :meth:`StreamArm.mask_outliers` and similar functions
            can specify the outlier detection method by the class' qualitative
            name, rather than requiring an instance of the class.
